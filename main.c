...
#define PROB1 1 #define PROB2 2 #define PROB3 3 #define PROB4 4 #define PROB5 5 #define PROB6 6
...
#if(PROB == PROB1) void conv(unsigned long var) { int reminder, v[sizeof(var) * 8], nr_1 = 0, nr_0 = 0, k = 0; while (var != 0) { reminder = var % 2; var = var / 2;
